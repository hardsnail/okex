package com.okex.c2c.example.httpclient;
...
public class Https {
    ...
    private static String URL = "https://www.okb.com/v2/c2c-open/tradingOrders/group?digitalCurrencySymbol=usdt&legalCurrencySymbol=cny&best=1&exchangeRateLevel=0&paySupport=0";
    ...
    public static void get() {
        try {
            ...
            Content content = Request.Get(URL).addHeader(authorizationHeader).addHeader(cookieHeader).addHeader(userAgentHeader).execute().returnContent();
